...
public class ProductsAdapter extends RecyclerView.Adapter<ProductsAdapter.ViewHolder> {
  ...
  /*  private final Integer[] category_img = new Integer[]{
    ...
    public ProductsAdapter(Context c, List<Integer> product_list) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = mInflater.inflate(R.layout.grid_products, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        if(position == 1){
            ...
            holder.tvProductName1.setText("Mother dairy Toned Milk");
            holder.tv_price.setText("MRP RS 56");
        }else if (position == 0){
            holder.tvProductName.setText("Mother Dairy");
            holder.tvProductName1.setText("Lite UHT double Toned Milk");
            holder.tv_price.setText(" MRP RS 28");
